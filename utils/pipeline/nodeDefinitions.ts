...
export const nodeDefinitions: NodeDefinition[] = [
  ...
  },
  {
    ...
    description: 'Fetches basic income-statement figures (revenue, net income, margins, growth, debt) for the symbol from Yahoo Finance, cached ~1 day since fundamentals only change quarterly',
    category: 'input',
    color: '#2979ff',
    pro: true,
    inputs: [{ id: 'symbol', label: 'Symbol', type: 'symbol' }],
    outputs: [{ id: 'fundamentals', label: 'Fundamentals', type: 'any' }],
    defaultData: {},
  },
  {
    type: 'fundamentalAnalysis',
    label: 'Fundamental Analysis',
    description: 'Turns income-statement figures into a very basic 0-100 score from simple profitability, growth, leverage and valuation checks — a gut-check, not a full analyst report. Feed into Recommendation',
    category: 'process',
    color: '#00c853',
    pro: true,
    inputs: [{ id: 'fundamentals', label: 'Fundamentals', type: 'any' }],
    outputs: [{ id: 'fundamentalScore', label: 'Score', type: 'scalar' }],
    defaultData: {},
  },
  {
