...
export const nodeDefinitions: NodeDefinition[] = [
  {
    ...
    pro: false,
    inputs: [],
    outputs: [{ id: 'symbol', label: 'Symbol (symbol)', type: 'symbol' }],
  ...
  },
  {
    ...
    pro: false,
    inputs: [],
    outputs: [{ id: 'value', label: 'Value (scalar)', type: 'scalar' }],
    defaultData: { value: 1 },
  },
  {
    type: 'symbolInput',
  ...
  },
  {
    ...
    color: '#2979ff',
    pro: false,
    inputs: [{ id: 'symbol', label: 'Symbol (symbol)', type: 'symbol' }],
    outputs: [
      { id: 'price', label: 'Price (price)', type: 'price' },
      { id: 'history', label: 'History (series)', type: 'series' },
    ],
    defaultData: {},
  },
  {
    ...
    color: '#00c853',
    pro: false,
    inputs: [{ id: 'series', label: 'Price Series (series)', type: 'series' }],
    outputs: [
      { id: 'smoothed', label: 'Smoothed (series)', type: 'series' },
      { id: 'trend', label: 'Trend (series)', type: 'series' },
      { id: 'signal', label: 'Signal (signal)', type: 'signal' },
    ],
    defaultData: {},
  },
  {
    ...
    pro: false,
    inputs: [
      { id: 'series', label: 'Main Series (price[])', type: 'series' },
      { id: 'overlay1', label: 'Overlay 1 (series)', type: 'series' },
      { id: 'overlay2', label: 'Overlay 2 (series)', type: 'series' },
      { id: 'overlay3', label: 'Overlay 3 (series)', type: 'series' },
    ],
    outputs: [],
    defaultData: {},
  },
